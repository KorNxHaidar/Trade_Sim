...
# หาตำแหน่งของไฟล์ kgi.py นี้
# SCRIPT_DIR จะเป็น /.../tradeSim_0.1.5/strategy
try:
...
# PROJECT_ROOT คือการ "เดินถอยหลัง" 1 ก้าวจาก SCRIPT_DIR
# จะได้ Path ไปที่ /.../tradeSim_0.1.5/
PROJECT_ROOT = os.path.dirname(SCRIPT_DIR)

# สร้าง Path ที่เราจะใช้แทน Path ของ Google Drive
...
# (คำถามของคุณ: competition_api_results สร้างใหม่ได้ป่ะ? -> ได้ครับ โค้ดนี้จะสร้างให้เองถ้ายังไม่มี)
